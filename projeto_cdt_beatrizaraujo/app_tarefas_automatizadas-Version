...
BORDA_ESCURO = "#453943"
TEXTO_ESCURO = "#FFFFFF"
TEXTO_SECUNDARIO_ESCURO = "#C9BEC6"
...
def identificar_categoria(texto):
    ...
    if any(p in texto for p in [
        ...
        "planilha", "arquivo", "pdf", "organizar"
    ]):
        return "DOCUMENTOS"
    ...
    if any(p in texto for p in [
        "cliente", "venda", "vendas", "proposta", "organizar"
    ]):
    ...
    if any(p in texto for p in [
        ...
        "código", "codigo", "sistema",
        "software", "computador" "organizar"
    ]):
        return "TECNOLOGIA"
...
class Aplicativo(tk.Tk):
    ...
    def cores_tema(self):
        ...
        if self.modo_escuro:
            ...
            return {
                ...
                "campo": CAMPO_ESCURO,
                "texto": TEXTO_ESCURO,
                "secundario": TEXTO_SECUNDARIO_ESCURO,
                "borda": BORDA_ESCURO
            }
    ...
    def aplicar_tema(self):
        ...
        cores = self.cores_tema()

        self.configure(
            bg=cores["fundo"]
        )

        self.conteudo.configure(
            bg=cores["fundo"]
        )
    ...
    def atualizar_widgets(self, widget, cores):

        # Não altera a sidebar vinho
    ...
    def mostrar_dashboard(self):
        ...
        self.dashboard_texto = tk.Text(
            ...
            height=5,
            font=("Segoe UI", 10),
            bg="#4A2534" if not self.modo_escuro else CAMPO_ESCURO,
            fg=BRANCO,
            insertbackground=BRANCO,
            relief="flat",
            bd=0,
        ...
        tk.Button(
            ...
            bg=cores["card"],
            fg=VINHO_CLARO if self.modo_escuro else VINHO,
            activebackground=cores["campo"],
            relief="flat",
            bd=0,
            font=("Segoe UI", 8, "bold"),
